...
class User {
    ...
    createUserCard() {
        ...
        <li id="${this.dc_comic.id}">
        <button class="remove" data-dc_comic-id="${this.dc_comic.id}">Remove</button>
        </li>
        </ul>
        </div>
        </main> `
    ...
    // <div class="container">
    //         <img src="C:\Users\david\dev\flatiron\labs\DC-Comics\dc-comics-frontend\assets\dc-universe-dc-comics.jpg">
    ...
    //     <form id="user-form">
    //         <label> User: <input type="text" name="new-user" id="new-user"></label>
